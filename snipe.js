...
(async () => {
    ...
    const crawler = await puppeteerCrawler({
        ...
        urls: [{ url: 'https://books.toscrape.com/catalogue/category/books/romance_8/index.html', userData: {}, batchName: 'books', unshift: false, retry: false, retries: 0, sync: false }],
